                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-300">Our visa specialists stay up-to-date with the latest requirements for every major study destination</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-300">We provide tailored guidance based on your specific circumstances</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-300">Our comprehensive interview preparation helps you approach your visa interview with confidence</p>
                      </div>
                    </div>
        ...
        <div className="mb-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold mb-6">Our Comprehensive Visa Support Process</h2>
              <p className="text-slate-600 dark:text-slate-300 mb-6">
                We've developed a systematic approach to visa applications that ensures nothing is overlooked. Our process is designed to maximize your chances of approval while minimizing stress and uncertainty.
              </p>

              <div className="space-y-6">
                <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm">
                  <div className="flex items-start gap-4">
                    <div className="flex items-center justify-center w-8 h-8 rounded-full bg-purple-600 text-white shrink-0">
                      1
                    </div>
                    <div>
                      <h3 className="font-bold text-lg mb-2">Initial Consultation and Assessment</h3>
                      <p className="text-slate-600 dark:text-slate-300 text-sm">
                        We begin with a thorough review of your academic background, chosen program, and destination country. Our experts will assess your eligibility and outline the specific visa requirements.
                      </p>
                      <div className="flex items-center gap-2 mt-3 text-purple-600 dark:text-purple-400">
                        <Calendar className="h-4 w-4" />
                        <span className="text-xs font-medium">Timeline: 1-2 days</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 dark:text-slate-300 text-sm">
                        We provide a comprehensive checklist and guide you through collecting each required item. From transcripts to financial statements, we ensure every document meets the exact specifications.
                      </p>
                      <div className="flex items-center gap-2 mt-3 text-purple-600 dark:text-purple-400">
                        <Calendar className="h-4 w-4" />
                        <span className="text-xs font-medium">Timeline: 1-2 weeks</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-lg mb-2">Application Form Mastery</h3>
                      <p className="text-slate-600 dark:text-slate-300 text-sm">
                        Our team assists you in filling out every section accurately, explaining the nuances and ensuring your responses align perfectly with your supporting documents.
                      </p>
                      <div className="flex items-center gap-2 mt-3 text-purple-600 dark:text-purple-400">
                        <Calendar className="h-4 w-4" />
                        <span className="text-xs font-medium">Timeline: 3-5 days</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-300 text-sm">
                      We conduct thorough mock interviews, preparing you for potential questions and helping you articulate your study plans confidently. With our guidance, you'll approach your visa interview with poise.
                    </p>
                    <div className="flex items-center gap-2 mt-3 text-purple-600 dark:text-purple-400">
                      <Calendar className="h-4 w-4" />
                      <span className="text-xs font-medium">Timeline: 1 week</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2">Submission and Follow-up</h3>
                    <p className="text-slate-600 dark:text-slate-300 text-sm">
                      Our team assists with the submission process, ensures all documents are properly filed, and helps you track your application status. If additional information is requested, we're here to help.
                    </p>
                    <div className="flex items-center gap-2 mt-3 text-purple-600 dark:text-purple-400">
                      <Calendar className="h-4 w-4" />
                      <span className="text-xs font-medium">Timeline: Ongoing</span>
                    </div>
                  </div>
                </div>
              </div>

              <div className="bg-gradient-to-br from-purple-50 to-slate-50 dark:from-purple-900/20 dark:to-slate-800/50 p-6 rounded-lg">
                <div className="flex items-start gap-4">
                  <div className="bg-purple-100 dark:bg-purple-800 rounded-full w-12 h-12 flex items-center justify-center shrink-0">
                    <FileCheck className="h-6 w-6 text-purple-600 dark:text-purple-300" />
                  </div>
                  <div>
                    <h3 className="font-bold text-lg mb-2">Our Commitment</h3>
                    <p className="text-slate-600 dark:text-slate-300 text-sm">
                      We stand by our service with a commitment to excellence. If your visa application is denied despite following our guidance, we'll help you reapply at a reduced service fee.
                    </p>
                    <div className="mt-3">
                      <Link href="/pricing" className="text-sm font-medium text-purple-600 dark:text-purple-400 flex items-center gap-1">
                        <span>View our service guarantees</span>
                        <ChevronRight className="h-4 w-4" />
                      </Link>
                    </div>
                  </div>
