  ...
  return (
    <div className="container mx-auto py-12 px-4">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16 items-center">
        <div>
          <div className="inline-block px-3 py-1 mb-6 text-xs font-semibold bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-purple-100 rounded-full">
            Visa Services
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Navigate Your{" "}
            <span className="text-yellow-300">Visa Journey</span> with Confidence
          </h1>
        ...
        <div className="relative">
          ...
          <div className="relative z-10 bg-card p-6 rounded-lg border border-purple-100 dark:border-purple-700 shadow-md">
            <div className="space-y-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Our visa specialists stay up-to-date with the latest requirements for every major study destination</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">We provide tailored guidance based on your specific circumstances</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Our comprehensive interview preparation helps you approach your visa interview with confidence</p>
                </div>
              </div>
